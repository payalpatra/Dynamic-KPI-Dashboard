...
import Dashboard from "../../partials/dashboard/DashboardCard11"
                ...
                <div className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg" ref={searchContent}>
                    ...
                    <form className="border-b border-gray-200">
                        <div className="relative">
                            ...
                            <input id="modal-search" className="w-full border-0 focus:ring-transparent placeholder-gray-400 appearance-none ml-1 py-3 pl-10 pr-4" type="search" placeholder="Add Customers..." ref={searchInput} />
