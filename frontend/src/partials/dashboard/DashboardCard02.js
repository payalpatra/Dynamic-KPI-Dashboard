...
function DashboardCard02() {
  ...
  let Data = [
    ...
    {
      MLabels: ["01-01-2021", "02-01-2021", "03-01-2021", "04-01-2021", "05-01-2021", "06-01-2021"]
    },
    { CapexData: [9200, 6600, 8800, 5200, 9200, 6600] },
    { DividendsData: [2600, 5350, 4000, 7500, 2000, 1700] },
    {
      Clabels: ['01-01-2021', '02-01-2021', '03-01-2021', '04-01-2021', '05-01-2021', '06-01-2021']
    },
  ...
  const UpdateKPI = (e) => {
    ...
    // Input DATA FOR CAPEX VS DIVIDENDS
  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-white shadow-lg mt-0 rounded-sm border border-gray-200">
      <header className="px-5 py-4 border-b border-gray-100">
        <h2 className="font-semibold text-gray-800">Update KPIS For The Next Month</h2>
        {failure === true && <p className="text-red-600 font-bold">Invalid Inputs</p>}
        {success === true && <p className="text-green-600 font-bold">Data Updated Successfully</p>}
      </header>
      <div className="p-8">
                ...
                KPIS.map(kpi => {
                  return (
                    <tr key={kpi.id}>
                      ...
                      {kpi.Data3 ? (<td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium text-indigo-500">
                          <input
